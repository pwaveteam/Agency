...
<div className="group relative bg-white rounded-[14px] overflow-hidden border border-gray-200 transition-all duration-500 cursor-pointer hover:shadow-[0_8px_20px_rgba(0,0,0,0.05)]">
...
className="px-[30px] py-[11px] text-[15px]"
>
더보기
</Button>
</div>
